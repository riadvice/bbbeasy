...
const Install = () => {
            ...
            <div className="company-container">
                ...
                <div className="box last">
                    ...
                    <div className="colors-container">
                        <Form.Item label={<T _str="Primary color" />} name="primary_color">
                            <ColorPicker
                                animation="slide-up"
                        ...
                        <Form.Item label={<T _str="Secondary color" />} name="secondary_color">
                            <ColorPicker
                                animation="slide-up"
                        ...
                        <Form.Item label={<T _str="Accent color" />} name="accent_color">
                            <ColorPicker
                                animation="slide-up"
                        ...
                        <Form.Item label={<T _str="Additional color" />} name="add_color">
                            <ColorPicker
                                animation="slide-up"
                ...
                <Card bordered={false}>
                    {presets.map((item) => (
                        <Card.Grid key={item.title} className="presets-grid" onClick={() => showModal(item.title)}>
                            <Meta avatar={<Avatar src={getIcon(item.title)} />} title={item.title} />
                        </Card.Grid>
                    ))}
    ...
    const onFinish = () => {
        if (activeStep < steps.length - 1) {
            ...
            const form = stepForm.getFieldsValue(true);
            ...
            axios
                .post('http://api.hivelvet.test/install', fdata)
                .then((response) => {
            ...
            <Col span={steps[activeStep].span} offset={steps[activeStep].offset}>
                ...
                >
                    ...
                    >
                        ...
                        {activeStep > 0 && (
                            <Button className="prev" onClick={() => prev()} size="large" block>
                                Previous
                            </Button>
                        )}
                    </Form.Item>
