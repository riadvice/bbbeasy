 ...
 */
 ...
 const Labels = () => {
     ...
     const handleAdd = (values) => {
         ...
         LabelsService.add_Label(formValues)
             ...
             .catch((error) => {
                 ...
                 console.log("error labels add ",responseData);
     ...
     const EditableCell: React.FC<EditableCellProps> = ({ editing, children, dataIndex, record, ...restProps }) => {
       console.log("dataindex ",errorsEdit[dataIndex]);
       console.log("key =",Object.keys(EN_US).filter((elem) => {
         EN_US[elem] == "Label Name already exists";
     }));
         const EditableCol = (
             <Space size="middle">
                 <Form.Item
